...
addSearchAlias("t", "startpage", "https://www.startpage.com/sp/search?q=", "s");

settings.defaultSearchEngine = "t";
...
const hintsCss =
  "font-size: 10pt; font-family: 'JetBrains Mono NL', 'Cascadia Code', 'Helvetica Neue', Helvetica, Arial, sans-serif; border: 0px; color: #cdd6f4 !important; background: #1e1e2e; background-color: #1e1e2e";
...
settings.theme = `
  ...
  #sk_omnibar {
    ...
    left: 10%;
    text-align: left;
    box-shadow: 0px 2px 10px #1e1e2e;
    z-index: 2147483000;
  }
  .sk_omnibar_middle {
    top: 10%;
  ...
  .sk_theme #sk_omnibarSearchResult>ul>li .omnibar_highlight {
    text-shadow: 0 0 0.01em;
    color: #a6e3a1;
  }
  ...
  kbd {
    ...
    border-bottom-lolor: #45475a;
    border-radius: 3px;
    box-shadow: inset 0 -1px 0 #1e1e2e;
  }
  #sk_banner {
    padding: 0.5rem;
    position: fixed;
  ...
  div.sk_tab {
    ...
    box-shadow: 0px 3px 7px 0px #1e1e2e;
  }
  div.sk_tab_wrap {
    display: inline-block;
  }
  ...
  div.sk_arrow[dir=down]>div:nth-of-type(2) {
    border-top: 10px solid #cdd6f4;
  }
  div.sk_arrow[dir=up]>div:nth-of-type(2) {
    top: 2px;
    border-bottom: 10px solid #cdd6f4;
  }
